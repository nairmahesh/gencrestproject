...
const TSMDashboard: React.FC = () => {
  ...
  const currentPlan = {
    id: 'PLAN-2024-01',
    title: 'January 2024 Monthly Plan - MDO Team & Self',
    createdBy: 'Priya Sharma',
    createdByRole: 'TSM',
    createdDate: '2024-01-20',
    status: 'Pending Approval',
    period: 'January 2024',
    pendingWith: 'Amit Patel (RBH)',
    submittedDate: '2024-01-20',
    activities: {
      planned: 65, // 45 for MDO team + 20 for self
      mdoActivities: 45,
      selfActivities: 20
    },
    targets: {
      ...
      <div className="gradient-bg rounded-2xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div 
              className="mt-4 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg p-3 cursor-pointer hover:bg-opacity-30 transition-colors"
              onClick={() => setShowPlanModal(true)}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <Calendar className="w-4 h-4 text-white" />
                  <span className="text-sm font-medium text-white">Monthly Plan - Pending Approval</span>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b bg-yellow-50">
              <div>
                <h3 className="text-xl font-semibold text-gray-900">Current Monthly Plan</h3>
                <p className="text-sm text-yellow-600">{currentPlan.title}</p>
              </div>
              <button
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              <div className="space-y-6">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-medium text-yellow-800">Plan Status</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-yellow-700">
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-yellow-800">{currentPlan.pendingWith}</div>
                    </div>
                    <div>
                      <span className="font-medium">Submitted on:</span>
                      <div>{new Date(currentPlan.submittedDate).toLocaleDateString()}</div>
                    </div>
                  </div>
                  <div className="mt-3 p-2 bg-yellow-100 rounded text-xs text-yellow-800">
                    <strong>Note:</strong> This plan covers both MDO team activities and your own TSM activities. Awaiting RBH approval.
                  </div>
                </div>

                {/* Activities Breakdown */}
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-4">Activities Breakdown</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-blue-50 rounded-lg p-4">
                      <h5 className="font-medium text-blue-800 mb-2">MDO Team Activities</h5>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-900">{currentPlan.activities.mdoActivities}</div>
                        <div className="text-xs text-blue-600">Planned for Team</div>
                      </div>
                    </div>
                    <div className="bg-purple-50 rounded-lg p-4">
                      <h5 className="font-medium text-purple-800 mb-2">TSM Self Activities</h5>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-purple-900">{currentPlan.activities.selfActivities}</div>
                        <div className="text-xs text-purple-600">Planned for Self</div>
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-xl font-bold text-gray-900">{currentPlan.activities.planned}</div>
                    <div className="text-sm text-gray-600">Total Activities Planned</div>
                  </div>
                </div>

                {/* Monthly Targets */}
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-4">Monthly Targets</h4>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Team Visits Target</span>
                      <span className="font-semibold text-gray-900">{currentPlan.targets.teamVisits}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Self Visits Target</span>
                      <span className="font-semibold text-gray-900">{currentPlan.targets.selfVisits}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Team Sales Target</span>
                      <span className="font-semibold text-gray-900">₹{(currentPlan.targets.teamSales / 100000).toFixed(1)}L</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Self Sales Target</span>
                      <span className="font-semibold text-gray-900">₹{(currentPlan.targets.selfSales / 100000).toFixed(1)}L</span>
                    </div>
                    <div className="flex items-center justify-between">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="font-medium text-gray-900">Plan Created</div>
                        <div className="text-xs text-gray-500">By {currentPlan.createdBy} on {new Date(currentPlan.createdDate).toLocaleDateString()}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-500">Waiting for {currentPlan.pendingWith}</div>
                      </div>
                    </div>
                  </div>
                </div>

...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stock Liquidation Overview - Modern Design */}
      <div className="bg-white rounded-xl p-6 card-shadow">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Stock Liquidation Overview (Farmer Sales Only)</h2>
            <p className="text-sm text-gray-500 mt-1">
              <strong>🌾 LIQUIDATION = Stock sold to farmers only (non-returnable)</strong> • Includes retailer-to-farmer sales • Last updated: {new Date().toLocaleDateString('en-IN', { 
              year: 'numeric', 
              month: 'short', 
              day: 'numeric',
              hour: '2-digit',
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-green-700">{farmerSalesTracking.totalFarmerSales.toLocaleString()}</div>
            ...
            <div className="bg-white rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-green-700">₹{farmerSalesTracking.totalFarmerSalesValue.toFixed(2)}L</div>
            ...
            <div className="bg-white rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-green-700">{farmerSalesTracking.distributorBreakdown.length}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-green-100">🌾 Liquidation Value (All Farmer Sales)</p>
                <p className="text-3xl font-bold">₹{overallMetrics.liquidation.value.toFixed(2)}L</p>
                <p className="text-green-200 text-sm mt-1">Direct + Via Retailers</p>
              </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">🌾 Liquidation Progress (All Farmer Sales)</h3>
